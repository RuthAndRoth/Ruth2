...
get_textures() {
    if (is_SL()) {
        ...
        if (GetGridName() == "OSGrid") {
            ...
            options_texture = "0c52513a-edf9-496e-9053-028c19412df2";
            skin_texture = "2b8dbb13-8cfe-4f10-bfd0-c2362d8261e9";
...
default {
    ...
    object_rez(key id) {
        ...
        if (counter == 1) {
            ...
            link_me = TRUE;
            rez_object("doll", alpha_doll_pos, <PI_BY_TWO, 0.0, -PI_BY_TWO>);
        }
        else if (counter == 8) {
            log("Rezzing buttons");
            link_me = TRUE;
